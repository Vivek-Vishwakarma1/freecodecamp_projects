...
class UnitTests(unittest.TestCase):
    ...
    def test_two_days_later_with_day(self):
        ...
        self.assertEqual(actual, expected, 'Expected calling "add_time()" with "11:59 PM", "24:05", "Wednesday" to return "00:04 AM, Friday (2 days later)"')
